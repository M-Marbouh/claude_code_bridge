...
metadata:
  short-description: designer plans + inspiration brainstorms + reviewer ratifies
---
...
- `reviewer` ratifies the plan (concur / concur-with-amendment / contest / insufficient-evidence)

...
- **Codex reviews every subagent-authored diff.** Claude labels which diffs came from a subagent. Review depth scales with risk; trivial changes Claude makes directly keep the fast path.
